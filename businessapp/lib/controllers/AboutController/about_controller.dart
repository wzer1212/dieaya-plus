...
class SettingsService {
  ...
  Future<SettingsResponse?> fetchAboutUs() async {
    try {
      ...
      final response = await httpService.get(Uri.parse(ApiConstants.aboutUs));
  ...
  Future<SettingsResponse?> fetchPrivacyPolicy() async {
    try {
      final httpService = HttpService.instance;
      final response = await httpService.get(Uri.parse(ApiConstants.privacyPolicy));
  ...
  Future<SettingsResponse?> fetchTerms() async {
    try {
      final httpService = HttpService.instance;
      final response = await httpService.get(Uri.parse(ApiConstants.termsConditions));
