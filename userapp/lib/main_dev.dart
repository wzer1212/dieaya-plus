...
void main() async {
  ...
  // ApiConstants.baseUrl = "https://dev.dieaya-plus.com/api";
  ApiConstants.shareBaseUrl = 'https://dev.dieaya-plus.com';
  ...
  static Future<void> init() async {
    ...
    if (initialLink != null) {
      ...
      if (uri.pathSegments.isNotEmpty && uri.pathSegments[0] == 'product') {
        String productId = uri.pathSegments[1]; // extract productId
      ...
      if (uri.pathSegments.isNotEmpty && uri.pathSegments[0] == 'market') {
        String marketId = uri.pathSegments[1]; // extract marketId
      ...
      if (uri.pathSegments.isNotEmpty && uri.pathSegments[0] == 'offer') {
        String offerId = uri.pathSegments[1]; // extract offerId
